...
// Encoded inline rather than as a Tailwind arbitrary-value class: the raw SVG contains spaces,
// and Tailwind's `bg-[url(...)]` arbitrary-value parser splits on unescaped whitespace, which

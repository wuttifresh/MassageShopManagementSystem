/// A booking's *display* channel: `channel` (LINE) when set by the multi-channel entry
...
export const BOOKING_CHANNEL_KEYS = ["LINE", "ONLINE", "WALK_IN", "PHONE", "ADMIN"] as const;

...
// eslint-disable-next-line @typescript-eslint/no-unused-vars -- kept for re-enabling later, see POST above
async function createBookingFromWebOrLine(request: Request) {
